...
const data = [
    ...
    {image: 'private.png', name: 'Конфиденциальные проекты', description: 'Разработка фронтенд части проектов на стеке React + Redux(который заменили на effector). Использование методологии atomic design, styled components для стилизации. Приватный npm регстр (nexus). Пакетный менеджер lerna. SSE, Websocket. React Testing Library.'},
